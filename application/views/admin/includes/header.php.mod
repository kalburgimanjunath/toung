...
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Ubuntu:700,700italic|Cantarell:400,700">
...
<div id="header" class="shadow">
	<div class="headercontent">
		<div class="name">ASKF KGDSV</div>
		<div class="headline">Design & Development + Thought for the Future.</div>
