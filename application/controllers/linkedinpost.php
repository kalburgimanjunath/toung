<?php
class Linkedinpost extends Controller {
	public $e;
	...
	public $linkedinData = array(
		'consumer_key'  => 'h44vvpbkitnq',
		'consumer_secret' => 'uVdMQ1nsA5DZo42S',
		'callback_url' => NULL
	);
	function index()
	{		
      ...
      <?php
		...
		if((is_array($arrSession)) && (array_key_exists('oauth', $arrSession))) {
			return TRUE;
		  } else {
			return FALSE;
		  }
      ...
      <html lang="en">
        ...
        <body>
          ...
          if($_SESSION['oauth']['linkedin']['authorized'] === TRUE) {
            ...
            // user isn't connected
            ?>
            <form id="linkedin_connect_form" action="https://localhost/linkedinpost" method="get">
              <input type="hidden" name="<?php echo LINKEDIN::_GET_TYPE;?>" id="<?php echo LINKEDIN::_GET_TYPE;?>" value="initiate" />
              <input type="submit" value="Connect to LinkedIn" />
            </form>
            <?php
