...
background-image:url(../images/01.jpg);background-position:left top;background-repeat:no-repeat;}
...
@font-face {
    ...
    src: url('http://demo.duotive.org/duotive-fortune/wp-content/themes/duotive-fortune/fonts/custom/AftaSansThin-Regular-webfont.eot');
    src: url('http://demo.duotive.org/duotive-fortune/wp-content/themes/duotive-fortune/fonts/custom/AftaSansThin-Regular-webfont.eot?iefix') format('eot'),
         url('http://demo.duotive.org/duotive-fortune/wp-content/themes/duotive-fortune/fonts/custom/AftaSansThin-Regular-webfont.woff') format('woff'),
         url('http://demo.duotive.org/duotive-fortune/wp-content/themes/duotive-fortune/fonts/custom/AftaSansThin-Regular-webfont.ttf') format('truetype'),
         url('http://demo.duotive.org/duotive-fortune/wp-content/themes/duotive-fortune/fonts/custom/AftaSansThin-Regular-webfont.svg#AftaSansThin-Regular') format('svg');
    font-weight: normal;
    font-style: normal;
}
...
{
	font-family:AftaSansThin-Regular, Tahoma, Helvetica, Arial, sans-serif;   
...
::-moz-selection{ background: #8AB28D; color:#fff; text-shadow: none; }
::selection { background:#8AB28D; color:#fff; text-shadow: none; }
#mainmenu ul > li a:link,
#mainmenu ul > li a:visited,
